...
urlpatterns = patterns('common.common_views',
  ...
  url(r'^config\.(?P<format>json|xml|html)?$', 'config_admin', name='config_admin_format'),
...
urlpatterns += patterns('common.common_views',
  ...
  url(r'^blocks/config/(?P<uuid>[-_\w\d]+)$', 'blocks_config', name='blocks_config'),
...
urlpatterns += patterns('common.common_views',
  ...
  url(r'^menus/menu/delete/(?P<slug>[-_\w\d]+)$', 'category_delete', {"model": Menu}, name='menu_delete'),
)